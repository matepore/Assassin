...
public abstract class BaseRelic extends CustomRelic {
    ...
    protected void loadTexture() {
        this.img = TextureLoader.getTextureNull(assassinRa.relicPath(imageName + ".png"), true);
        if (img != null) {
            outlineImg = TextureLoader.getTextureNull(assassinRa.relicPath(imageName + "Outline.png"), true);
            if (outlineImg == null)
                outlineImg = img;
        }
        else {
    ...
    public void loadLargeImg() {
        if (largeImg == null) {
            this.largeImg = ImageMaster.loadImage(assassinRa.relicPath("large/" + imageName + ".png"));
        }
    }
