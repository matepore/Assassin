...
import static assassinRa.assassinRa.characterPath;
import static assassinRa.assassinRa.makeID;

public class AssassinCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Assassin"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(AssassinBaseRelic.ID);
